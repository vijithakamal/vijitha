...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="vijitha k.jpeg" alt="your profile picture" class="profile=picture">
               <h1>vijitha</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is VIJITHA K and i am a computer science learner.</p>
                </div>
            </section>
